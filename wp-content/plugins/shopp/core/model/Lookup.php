...
class Lookup {
	...
	static function country_areas () {
		...
		$_['CA']['Eastern Canada'] = array('ON','PQ','NB','PE','NS','NF');
	...
	static function postcodes () {
		...
		$_['CA'] = array('Y'=>'YT', 'X'=>array('NT','NU'), 'V'=>'BC', 'T'=>'AB', 'S'=>'SK', 'R'=>'MB', 'K'=>'ON', 'L'=>'ON', 'M'=>'ON', 'N'=>'ON', 'P'=>'ON', 'G'=>'PQ', 'H'=>'PQ', 'J'=>'PQ', 'E'=>'NB', 'C'=>'PE', 'B'=>'NS', 'A'=>'NF');
